...
WITH source AS (
	...
	sites AS (
		SELECT
			...
			ref_nomenclatures.get_nomenclature_label((tsc.data->'id_nomenclature_hab')::integer) as habitat,
			ref_nomenclatures.get_nomenclature_label((tsc.data->'id_nomenclature_gest')::integer) as gestion,
