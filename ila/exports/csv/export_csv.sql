...
DROP VIEW  IF EXISTS  gn_monitoring.v_export_ila_standard;

CREATE OR REPLACE VIEW gn_monitoring.v_export_ila_standard AS
...
WITH source AS (
		...
		LIMIT 1
         ...
         SELECT tbs.id_base_site,
            ...
            ref_nomenclatures.get_nomenclature_label((tsc.data -> 'id_nomenclature_hab'::text)::integer) AS habitat,
            ref_nomenclatures.get_nomenclature_label((tsc.data -> 'id_nomenclature_gest'::text)::integer) AS gestion,
            ref_nomenclatures.get_nomenclature_label((tsc.data -> 'id_nomenclature_ah'::text)::integer) AS activite_humaine,
