DROP VIEW IF EXISTS cenhn.sh_pr_gn;
CREATE VIEW cenhn.sh_pr_gn AS
 SELECT
	-- groupe de site
...
LEFT JOIN steli_sterf.sh_synsystematique sy ON a.ID_Synsystematique = sy.IDsynsystematique
